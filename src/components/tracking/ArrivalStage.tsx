      ...
      <div className={`journey-card journey-card-${nodeState}`}>
        <div className="journey-stage-header">
          <div>
            ...
            <div className="journey-stage-id" style={{ color: arrived ? '#34d399' : 'var(--text-muted)' }}>
        ...
        {arrived ? (
          <div className="delivery-hero">
            ...
            <div style={{
              ...
              <div>
                <div style={{ fontSize: 9, fontWeight: 700, color: 'var(--text-muted)', textTransform: 'uppercase', letterSpacing: 0.8 }}>Arrival Time</div>
                <div style={{ fontFamily: 'var(--font-mono)', fontSize: 14, fontWeight: 700, color: '#34d399', marginTop: 3 }}>
                  {trip.completedAt || 'Recorded'}
                </div>
              </div>
              <div>
                <div style={{ fontSize: 9, fontWeight: 700, color: 'var(--text-muted)', textTransform: 'uppercase', letterSpacing: 0.8 }}>Status</div>
                <div style={{ fontSize: 14, fontWeight: 700, color: '#34d399', marginTop: 3 }}>
          ...
          <div style={{ padding: '20px 0', textAlign: 'center' }}>
            ...
            <div style={{
              ...
              borderRadius: 8, padding: '8px 16px', fontSize: 12, color: '#f59e0b', fontWeight: 600
            }}>
              <Clock size={13} />
              Expected: {trip.eta}
            </div>
